...
function mkCipher(i) {
  ...
  return {
    ...
    Name: enc(40), Notes: enc(200),
    Login: { Username: enc(30), Password: enc(40), Totp: enc(50), Uris: [{ Uri: enc(60), Match: null }] },
    Fields: [{ Name: enc(20), Value: enc(60), Type: 0 }],
    Favorite: false, Reprompt: 0, CollectionIds: [],
    RevisionDate: "2026-08-30T12:00:00.000Z", Attachments: null, Object: "cipherDetails",
  };
}
...
function sync() {
  ...
  for (const n of [100, 500, 1_000, 2_000, 5_000]) {
    const payload = {
      Profile: {}, Folders: [], Collections: [],
      Ciphers: Array.from({ length: n }, (_, i) => mkCipher(i)),
      Domains: {}, Sends: [], Policies: [], Object: "sync",
    };
    const t0 = process.hrtime.bigint();
